...
#   main  -- H.265 4K stream, scaled to 50% (2048x1080) for display  (default)
#   sub   -- H.264 1080p stream, displayed at native resolution
#
# Codec defaults match stream.conf: MAIN=H.265, SUB=H.264.
...
echo "Receiving ${STREAM} stream: $URL (${DEPAY}, latency=${LATENCY}ms)"
